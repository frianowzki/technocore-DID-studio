...
try {
  ...
  await call('Runtime.evaluate', { expression: "document.documentElement.style.scrollBehavior='auto'; window.scrollTo(0, document.body.scrollHeight)" }, sessionId);
  await new Promise((resolve) => setTimeout(resolve, 150));
